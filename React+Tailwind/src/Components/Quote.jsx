...
const Quote=()=>{
    return(
        <>
        <div className="h-[500px] w-[screen] bg-gray-200 flex flex-col justify-center items-center text-[26px] px-8 py-8">
            ...
            <div className="flex justify-end"><strong>-Thor, God of Thunder</strong></div>
        </div>
        </div>
